...
\begin{entrylist}
	...
	{2023}
        ...
        {
		Using a mixture of C, Zig, and Rust, created a CLAP plugin that simulates 
		a guitar amp in realtime
		\\
	...
	\entry
        ...
        {
		Implemented a single header api for sandboxing memory into a hierarchy of different heaps
        that use different allocation algorithms. Includes a bump allocator, malloc/free integration,
        and limited sanitizer integration.
		\\
        	\texttt{C}\slashsep{TDD}
	}
\end{entrylist}
